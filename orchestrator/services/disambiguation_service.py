...
_TYPE_KEYWORDS = [
    "temperature", "co2", "humidity", "air quality", "occupancy", "pressure",
    "illuminance", "light", "tvoc", "voc", "formaldehyde", "pm1", "pm2", "pm10",
    "no2", "oxygen", "o2", "sound", "noise", "pir", "motion", "mq2", "mq3",
    "mq5", "mq9", "co level", "carbon monoxide", "combustible", "ethyl",
    "alcohol", "lpg", "natural gas",
]
...
"""
        ...
        for b in data.get("results", {}).get("bindings", []):
            ...
            local_name = sensor_uri.split("#")[-1] if "#" in sensor_uri else sensor_uri.split("/")[-1]
    ...
    def format_clarification(
        ...
        examples = []
        for c in primary[:3]:
            kw = c["brick_class"].replace("Air_Temperature_Sensor", "temperature") \
