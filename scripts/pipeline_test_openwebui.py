...
def _build_question_bank() -> List[Dict[str, Any]]:
    ...
    # =====================================================================
    q("Q001", "general", "visitor", "general", "greeting", "simple",
      "Hello!",
      keywords=["hello", "hi", "welcome", "ontosage", "help", "assist"])

    q("Q002", "general", "visitor", "general", "capabilities", "simple",
      "What can you do for me?",
      keywords=["sensor", "temperature", "energy", "building", "data", "query", "help", "analys"],
      min_length=80)

    q("Q003", "student", "student", "general", "capabilities", "simple",
    ...
    q("Q004", "occupant", "occupant", "general", "greeting", "simple",
      "Good morning! I work on the 5th floor.",
      keywords=["hello", "hi", "morning", "welcome", "help", "floor", "assist"])

    q("Q005", "executive", "exec", "general", "capabilities", "simple",
    ...
    q("Q016", "occupant", "occupant", "analytics", "temperature", "simple",
      "Is my office comfortable right now? I sit in Zone 5.28.",
      keywords=["temperature", "comfort", "zone"])

    q("Q017", "student", "student", "general", "temperature", "simple",
    ...
    q("Q022", "researcher", "analyst", "compare", "air_quality", "complex",
      "Compare average CO2 today for zones 5.08 and 5.10.",
      numeric=True,
      keywords=["co2", "compare", "average", "zone"])

    q("Q023", "safety_officer", "safety", "anomaly", "air_quality", "complex",
    ...
    q("Q037", "executive", "exec", "analytics", "occupancy", "moderate",
    ...
    q("Q059", "it_admin", "it", "analytics", "data_quality", "complex",
      ...
      structured=True, min_length=100)

    q("Q060", "facility_manager", "fm", "analytics", "data_quality", "moderate",
    ...
    q("Q061", "it_admin", "it", "anomaly", "data_quality", "complex",
    ...
    # =====================================================================
    q("Q062", "safety_officer", "safety", "compliance", "compliance", "complex",
      "Check ASHRAE 55 thermal comfort compliance for Zone 5.28 today.",
      keywords=["ashrae", "comfort", "compliance", "zone"])

    q("Q063", "safety_officer", "safety", "compliance", "compliance", "complex",
    ...
    q("Q064", "sustainability_officer", "sustain", "compliance", "compliance", "complex",
    ...
    q("Q065", "safety_officer", "safety", "compliance", "compliance", "complex",
      "Run a full WELL v2 compliance check across all zones for today.",
      keywords=["well", "compliance", "zone", "air", "comfort"])

    q("Q066", "sustainability_officer", "sustain", "compliance", "compliance", "complex",
    ...
    q("Q067", "safety_officer", "safety", "compliance", "compliance", "moderate",
    ...
    q("Q068", "researcher", "analyst", "compliance", "compliance", "complex",
    ...
    q("Q069", "executive", "exec", "compliance", "compliance", "moderate",
    ...
    # =====================================================================
    q("Q070", "facility_manager", "fm", "anomaly", "anomaly", "moderate",
      "Detect any anomalies for Air_Temperature_Sensor_5.28 today.",
      keywords=["anomal", "sensor", "detect"])

    q("Q071", "facility_manager", "fm", "anomaly", "anomaly", "complex",
    ...
    q("Q072", "safety_officer", "safety", "anomaly", "anomaly", "complex",
      ...
      structured=True, min_length=80)

    q("Q073", "it_admin", "it", "anomaly", "anomaly", "moderate",
      "Has any sensor reported readings outside its normal operating range today?",
      keywords=["sensor", "range", "anomal", "reading"])

    q("Q074", "facility_manager", "fm", "anomaly", "anomaly", "complex",
    ...
    q("Q075", "energy_manager", "energy", "anomaly", "anomaly", "complex",
    ...
    q("Q080", "safety_officer", "safety", "report", "report", "complex",
    ...
    q("Q081", "executive", "exec", "report", "report", "complex",
      ...
      min_length=100, structured=True)

    # =====================================================================
    # SECTION 12: VISUALIZATION  (4 questions)
    # =====================================================================
    q("Q082", "researcher", "analyst", "analytics", "visualization", "moderate",
      "Plot temperature for Air_Temperature_Sensor_5.28 for today.",
      keywords=["plot", "temperature", "sensor", "chart", "graph", "image", "visual", "png", "svg"])

    q("Q083", "energy_manager", "energy", "analytics", "visualization", "complex",
      "Create a chart showing energy consumption by zone for the last 7 days.",
      keywords=["chart", "energy", "zone", "plot", "graph", "visual", "image"])

    q("Q084", "researcher", "analyst", "compare", "visualization", "complex",
    ...
    q("Q085", "facility_manager", "fm", "analytics", "visualization", "moderate",
    ...
    # =====================================================================
    q("Q086", "researcher", "analyst", "export", "export", "moderate",
    ...
    q("Q089", "facility_manager", "fm", "export", "export", "complex",
    ...
    q("Q092", "sustainability_officer", "sustain", "planner", "planner", "complex",
    ...
    q("Q093", "energy_manager", "energy", "recommend", "planner", "complex",
    ...
    q("Q094", "facility_manager", "fm", "recommend", "planner", "complex",
    ...
    q("Q095", "executive", "exec", "planner", "planner", "complex",
    ...
    # =====================================================================
    q("Q106", "general", "guest", "general", "out_of_domain", "edge",
      "What is the capital of France?",
      keywords=["building", "help", "assist", "sensor", "cannot", "outside", "scope",
                "paris", "france", "capital"])

    q("Q107", "student", "student", "general", "out_of_domain", "edge",
      "Can you write me a Python script to sort a list?",
      keywords=["building", "help", "assist", "sensor", "cannot", "outside", "scope",
                "focus", "specializ"])

    q("Q108", "general", "guest", "general", "out_of_domain", "edge",
      "What's the weather forecast for London tomorrow?",
      keywords=["building", "help", "sensor", "weather", "indoor", "cannot", "outside"])

    q("Q109", "general", "guest", "general", "out_of_domain", "edge",
    ...
    # =====================================================================
    q("Q110", "researcher", "analyst", "analytics", "multi_hop", "complex",
    ...
    q("Q111", "facility_manager", "fm", "analytics", "multi_hop", "complex",
    ...
    q("Q112", "energy_manager", "energy", "analytics", "multi_hop", "complex",
    ...
    q("Q113", "safety_officer", "safety", "analytics", "multi_hop", "complex",
    ...
    q("Q114", "researcher", "analyst", "analytics", "multi_hop", "complex",
    ...
    q("Q115", "executive", "exec", "analytics", "multi_hop", "complex",
    ...
    q("Q119", "it_admin", "it", "metadata", "metadata", "moderate",
    ...
    q("Q124", "occupant", "occupant", "analytics", "natural_language", "simple",
      "It smells weird on the 5th floor. What's going on?",
      keywords=["air", "ventilation", "sensor", "floor", "quality"])

    q("Q125", "general", "guest", "general", "natural_language", "simple",
    ...
    q("Q126", "occupant", "occupant", "analytics", "natural_language", "moderate",
      "I can hear the AC making noise but it still feels warm. Zone 5.28.",
      keywords=["temperature", "hvac", "zone", "warm", "ac", "sensor"])

    q("Q127", "general", "guest", "analytics", "natural_language", "moderate",
    ...
    q("Q135", "energy_manager", "energy", "analytics", "time_range", "complex",
      "Total energy consumption between 2026-04-06 and 2026-04-07 for Zone 5.12.",
      numeric=True,
      keywords=["energy", "total", "consumption", "zone"])

    q("Q136", "facility_manager", "fm", "analytics", "time_range", "moderate",
    ...
    # =====================================================================
    q("Q137", "general", "guest", "general", "stress", "edge",
      "",
      keywords=["help", "question", "assist", "empty"],
      min_length=5)

    q("Q138", "general", "guest", "general", "stress", "edge",
      "??????????",
      keywords=["help", "clarif", "understand", "question", "rephrase"])

    q("Q139", "general", "guest", "general", "stress", "edge",
        ...
        "turns": [
            {
                ...
                "expects": {"keywords": ["building", "performance", "energy", "comfort"], "min_length": 60},
            },
            {
    ...
    chains.append({
        ...
        "turns": [
            ...
            },
            {
                ...
                "expects": {"keywords": ["co2", "carbon", "air quality", "health"], "min_length": 40},
            },
            {
    ...
    chains.append({
        ...
        "turns": [
            ...
            },
            {
                ...
                "expects": {"keywords": ["recommend", "reduc", "energy", "efficien"], "min_length": 60},
            },
        ],
    })
...
_ERROR_INDICATORS = [
    "database error", "i apologize", "couldn't generate",
    "failed to", "internal error", "traceback", "exception",
    "timed out", "connection refused", "no response generated",
    "error occurred", "sorry, i", "unable to process",
    "internal server error", "keyerror", "typeerror", "valueerror",
    "attributeerror", "nameerror", "indexerror",
]

_SOFT_ERROR_INDICATORS = [
    "no data", "no results", "no readings", "not available",
    "could not find", "no sensors found",
]
...
_PERSONA_KEYWORDS = {
    "student": ["learn", "explain", "understand", "what is", "how does", "definition",
                "simple", "example", "analogy", "educational"],
    "researcher": ["statistic", "data", "analysis", "correlation", "variance",
                   "standard deviation", "confidence", "methodology", "dataset"],
    "facility_manager": ["maintenance", "action", "repair", "schedule", "operational",
                         "hvac", "status", "alert", "zone"],
    "occupant": ["comfortable", "comfort", "feel", "warm", "cold", "fresh",
                 "pleasant", "normal"],
    "energy_manager": ["kwh", "consumption", "efficiency", "cost", "peak",
                       "baseline", "saving", "carbon", "footprint"],
    "safety_officer": ["compliance", "threshold", "violation", "standard",
                       "ashrae", "well", "alert", "flag", "safe"],
    "it_admin": ["uuid", "database", "pipeline", "service", "api",
                 "connectivity", "diagnostic", "system", "config"],
    "executive": ["kpi", "summary", "overview", "strategic", "cost",
                  "recommendation", "highlight", "bottom line", "key"],
    "sustainability_officer": ["carbon", "leed", "breeam", "iso", "benchmark",
                               "sustainability", "green", "footprint", "target"],
    "general": [],
}
...
def _score_response(
    ...
    _SKIP_PERSONA_FIT_CATEGORIES = {"greeting", "capabilities", "ambiguous",
                                    "out_of_domain", "stress", "natural_language"}
    ...
    if expects.get("should_decline"):
        decline_signals = ["cannot", "unable", "not supported", "not possible",
                           "don't have", "not capable", "contact", "safety",
                           "not yet", "can't", "won't", "do not"]
    ...
    if total_weight > 0:
        composite = sum(dim_scores.get(k, 1.0) * w for k, w in active_weights.items()) / total_weight
    else:
        composite = 0.0

    # -- Verdict --
    fatal = any(
        i.startswith(("connection_failed", "server_error", "empty_response"))
        for i in issues
    )
...
def _write_markdown_report(report: Dict[str, Any], path: str) -> None:
    ...
    for label, cov_key in [
        ...
        for name in sorted(cov.keys()):
            ...
            matching = [r for r in report["results"] if r.get(cov_key.rstrip("s") if cov_key != "difficulty" else "difficulty", r.get(cov_key, "")) == name]
            if not matching:
                key_field = {"persona": "persona", "intent": "intent", "category": "category", "difficulty": "difficulty"}[cov_key]
                matching = [r for r in report["results"] if r.get(key_field) == name]
            avg_sc = round(statistics.mean([r["score"]["score"] for r in matching]), 3) if matching else 0
            lines.append(f"| {name} | {d['total']} | {d['pass']} | {d['warn']} | {d['fail']} | {pct}% | {avg_sc} |")
        lines.append("")
    ...
    if report.get("conversation_results"):
        ...
        for chain in report["conversation_results"]:
            ...
            for i, t in enumerate(chain["turns"], 1):
                ...
                lines.append(f"  {i}. [{v}] (score={t['score']['score']}, {t['elapsed_s']}s) Q: {t['question'][:80]}")
                if t["score"]["issues"]:
    ...
    if failed:
        ...
        for r in failed:
            ...
            lines.append(f"- **Status:** HTTP {r['status']} | Time: {r['elapsed_s']}s | Score: {r['score']['score']}")
    ...
    lines.append("")
    lines.append("| ID | Persona | Intent | Cat | Diff | Score | Verdict | Time | Response Len | Issues |")
    lines.append("|----|---------|--------|-----|------|-------|---------|------|-------------|--------|")
    ...
    if report.get("regression"):
        ...
        lines.append(f"- **Score Change:** {reg['prev_avg_score']} -> {reg['curr_avg_score']} ({reg['score_delta']:+.3f})")
        lines.append(f"- **Pass Rate Change:** {reg['prev_pass_rate']}% -> {reg['curr_pass_rate']}% ({reg['pass_rate_delta']:+.1f}%)")
        lines.append(f"- **Latency Change (mean):** {reg['prev_mean_latency']}s -> {reg['curr_mean_latency']}s ({reg['latency_delta']:+.3f}s)")
        lines.append("")
        if reg.get("regressions"):
            lines.append("### Regressions Detected")
            lines.append("")
            for item in reg["regressions"]:
                lines.append(f"- **{item['id']}**: score {item['prev_score']} -> {item['curr_score']} ({item['delta']:+.3f})")
            lines.append("")
    ...
    try:
        files = sorted(
            [f for f in os.listdir(out_dir)
             if f.startswith("pipeline_test_") and f.endswith(".json") and current_run_id not in f],
            reverse=True,
        )
        if files:
...
def _compare_reports(prev: Dict[str, Any], curr: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for qid in sorted(common_ids):
        ...
        if delta < -0.15:
            regressions.append({"id": qid, "prev_score": p_score, "curr_score": c_score, "delta": round(delta, 3)})
        elif delta > 0.15:
            improvements.append({"id": qid, "prev_score": p_score, "curr_score": c_score, "delta": round(delta, 3)})
        ...
        if not quiet:
            ...
            for svc, val in data.items():
                if isinstance(val, dict):
                    ...
                    svc_ok = str(val)
                icon = _green("OK") if str(svc_ok).lower() in ("ok", "true", "healthy", "up", "connected") else _red(str(svc_ok))
...
def main() -> int:
    ...
    parser.add_argument(
        "--difficulty", default=None, choices=["simple", "moderate", "complex", "edge"],
    ...
    if args.category:
        ...
        questions = [
            ...
            if q_["category"].lower() == _cat or q_["intent"].lower() == _cat
        ]
    if args.difficulty:
    ...
    for idx, q_ in enumerate(questions, 1):
        ...
        if not args.json_only:
            ...
            print(f"  {progress} {badge} {_bold(q_['id'])} {meta}  {_dim(f'{elapsed:.1f}s')}  score={score['score']}")
    ...
    if args.include_conversations:
        ...
        for chain in chains:
            if not args.json_only:
                print(f"  {_magenta('Chain ' + chain['id'] + ': ' + chain['label'])} ({chain['persona']})")
            ...
            for turn_idx, turn in enumerate(chain["turns"], 1):
                ...
                if not args.json_only:
                    v = c_score["verdict"]
                    badge = {
                        "pass": _green("PASS"), "warn": _yellow("WARN"), "fail": _red("FAIL")
                    }[v]
                    print(f"    Turn {turn_idx}: {badge} score={c_score['score']}  {_dim(f'{c_elapsed:.1f}s')}")
    ...
    if args.compare_last:
        ...
        if prev_report:
            ...
            if not args.json_only:
                ...
                print(f"  Score change:    {regression['prev_avg_score']} -> {regression['curr_avg_score']} ({delta_col})")

                pr_delta = regression["pass_rate_delta"]
                pr_str = f"{pr_delta:+.1f}%"
                pr_col = _green(pr_str) if pr_delta >= 0 else _red(pr_str)
                print(f"  Pass rate:       {regression['prev_pass_rate']}% -> {regression['curr_pass_rate']}% ({pr_col})")

                lat_delta = regression["latency_delta"]
                lat_str = f"{lat_delta:+.3f}s"
                lat_col = _green(lat_str) if lat_delta <= 0 else _red(lat_str)
                print(f"  Latency (mean):  {regression['prev_mean_latency']}s -> {regression['curr_mean_latency']}s ({lat_col})")

                if regression["regressions"]:
                    print()
                    print(f"  {_red('Regressions:')} {len(regression['regressions'])} questions got worse")
                    for item in regression["regressions"][:5]:
                        print(f"    {item['id']}: {item['prev_score']} -> {item['curr_score']} ({item['delta']:+.3f})")
                if regression["improvements"]:
                    print()
                    print(f"  {_green('Improvements:')} {len(regression['improvements'])} questions improved")
    ...
    if not args.json_only:
        ...
        grade = "A+" if s["pass_rate"] >= 95 else \
                "A"  if s["pass_rate"] >= 90 else \
                "B"  if s["pass_rate"] >= 80 else \
                "C"  if s["pass_rate"] >= 70 else \
                "D"  if s["pass_rate"] >= 60 else "F"
        ...
        if conversation_results:
            ...
            for chain in conversation_results:
                ...
                colour = _green if pct >= 75 else (_yellow if pct >= 50 else _red)
                print(f"    {chain['id']} {chain['label']:40s} {colour(f'{chain_pass}/{chain_total}')} ({pct}%)")
            print()
        ...
        if fail_n > 0:
            ...
            for r in results:
                if r["score"]["verdict"] == "fail":
                    print(f"    {_red(r['id']):8s} [{r['persona']}/{r['intent']}] {r['question'][:60]}")
